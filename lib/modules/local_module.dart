...
import 'package:simple/utils/encryption/xxtea.dart';
...
class LocalModule extends NetworkModule {
  ...
  @provide
  @singleton
  DataSource provideDataSource() => DataSource(provideDatabase());
  // DataSources End:-----------------------------------------------------------
  ...
  // (providePostApi(),
  //     provideSharedPreferenceHelper(), providePostDataSource());
}
